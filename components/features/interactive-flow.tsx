      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            No complex workflows or enterprise training. Just the results you've been dreaming of.
          </p>
        </div>
              ...
              >
                <div className={`relative h-full bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden ${
                  ...
                  <div className="relative p-8 md:p-10 text-center">
                    {/* Icon */}
                    <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${result.gradient} rounded-2xl text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300`}>
                      {result.icon}
                    </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 md:p-12 max-w-4xl mx-auto border border-indigo-100">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  <blockquote className="text-xl text-gray-700 mb-4 leading-relaxed">
                    "I went from checking support email every 30 minutes to checking it once a week. 
                    My stress dropped, my creativity returned, and my customers are happier than ever."
                  </blockquote>
                  <div className="flex items-center justify-center md:justify-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-pink-400 to-purple-400 rounded-full"></div>
                    <div>
                      <p className="font-semibold text-gray-900">Maria Rodriguez</p>
                      <p className="text-gray-600">Founder of Bloom & Thread</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-gray-100">
                <div className="text-center">
                  <div className="text-2xl font-bold text-indigo-600">$2.3M</div>
