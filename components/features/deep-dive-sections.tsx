...
import { CheckCircle2, Zap, Users, MessageSquare, ArrowRight } from "lucide-react"
          ...
          <div className="lg:w-1/2">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-4">
                ...
                <span className="text-gray-700">Knows which colors are selling fast and suggests alternatives</span>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 p-2 rounded-xl flex-shrink-0">
                  <CheckCircle2 className="h-5 w-5 text-blue-600" />
                </div>
                <span className="text-gray-700">Explains your sizing guide clearly with personalized recommendations</span>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-gradient-to-br from-blue-100 to-indigo-100 p-2 rounded-xl flex-shrink-0">
                  <CheckCircle2 className="h-5 w-5 text-blue-600" />
                </div>
                <span className="text-gray-700">Shares your brand story naturally while building connections</span>
              </li>
            </ul>
            ...
            <div className="bg-gradient-to-br from-purple-900 to-indigo-900 text-white p-8 rounded-3xl shadow-2xl relative overflow-hidden mb-8">
              ...
              <div className="relative z-10">
                <p className="text-xl font-medium mb-4 leading-relaxed">
                  &quot;I haven&apos;t touched our support email in three weeks. It&apos;s like having a whole team without the overhead.&quot;
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">Sam Martinez</p>
                    <p className="text-sm text-purple-200">Founder, Clay & Oak</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-2 border border-purple-100">
                ...
                <div className="absolute -top-4 -left-4 bg-gradient-to-br from-purple-600 to-pink-600 text-white px-4 py-2 rounded-2xl shadow-xl">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">Human available 24/7</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-1/2">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-4">
                ...
                <span className="text-gray-700">Matches your brand voice perfectly in every interaction</span>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-gradient-to-br from-green-100 to-emerald-100 p-2 rounded-xl flex-shrink-0">
                  <CheckCircle2 className="h-5 w-5 text-green-600" />
                </div>
                <span className="text-gray-700">Suggests products they&apos;ll actually love based on context</span>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-gradient-to-br from-green-100 to-emerald-100 p-2 rounded-xl flex-shrink-0">
                  <CheckCircle2 className="h-5 w-5 text-green-600" />
                </div>
                <span className="text-gray-700">Builds lasting relationships, not just transactions</span>
              </li>
            </ul>
          </div>
          <div className="lg:w-1/2 relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl border border-green-100 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4 text-white">
                  <div className="flex items-center">
                    ...
                    <span className="ml-auto text-sm opacity-90">Always Online</span>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3 justify-end">
                    <div className="flex-1 flex justify-end">
                      <div className="bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl rounded-tr-sm p-5 shadow-sm max-w-[320px]">
                        ...
                        <div className="text-xs text-green-100 mt-3 text-right">Just now</div>
                      </div>
                    </div>
                    <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-gray-200 to-gray-300 rounded-full flex items-center justify-center shadow-sm">
                      <span className="text-gray-700 font-bold text-xs">YP</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="bg-white rounded-2xl rounded-tl-sm px-5 py-4 shadow-sm border border-green-100">
                      <div className="flex space-x-1.5">
                        ...
                        <div className="w-2.5 h-2.5 bg-green-400 rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
