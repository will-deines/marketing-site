...
const investors: Investor[] = [
  {
    ...
    description: "Home Security Pioneer",
  },
  {
    id: "workshop",
    name: "Workshop.dev",
    logo: "/investors/workshop-dev-logo.png",
    description: "Developer Tools Expert",
  },
]
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="flex flex-col items-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-purple-50 border border-purple-200/50 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-purple-900">Backed by Industry Leaders</span>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="relative h-16 w-40 mb-4">
                  <Image
                    src={investor.logo || "/placeholder.svg?height=64&width=160"}
                    alt={investor.name}
                    fill
                ...
                <div className="text-center">
                  <p className={`font-semibold ${investor.id === "simplisafe" ? "text-white" : "text-gray-900"}`}>{investor.name}</p>
                  {investor.description && (
                    <p className={`text-sm mt-1 ${investor.id === "simplisafe" ? "text-gray-300" : "text-gray-600"}`}>{investor.description}</p>
                  )}
                </div>
              </div>
              ...
              <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white text-xs px-2 py-1 rounded-full shadow-md">
        ...
        <div className="mt-12 text-center">
          <p className="text-lg text-gray-700 font-medium">
            ...
            <span className="bg-gradient-to-r from-purple-600 to-purple-500 bg-clip-text text-transparent font-bold"> billion-dollar companies</span>
          </p>
          <p className="text-sm text-gray-600 mt-2">
            Our investors bring deep expertise in SaaS, e-commerce, and customer experience
          </p>
        </div>
      </div>
    </section>
