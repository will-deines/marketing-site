...
const stepData: StepData[] = [
  {
    ...
    description: "5-minute setup, your Garrio team is ready",
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div
          className={`text-center mb-8 transition-all duration-500 ${hasStarted ? "opacity-100" : "opacity-0"}`}
        >
            ...
            {!showXAxisLabels && (
              <div className="mb-4 text-center">
                <div className="inline-flex items-center gap-2 bg-purple-50 text-purple-700 px-4 py-2 rounded-full text-sm font-medium">
                  ...
                  <span>
                    Step {activeStep + 1}: {stepData[activeStep].name}
                  </span>
                </div>
              </div>
            )}
        ...
        <div className="mt-8 text-center">
          <div className="bg-white/80 backdrop-blur rounded-2xl border border-purple-200 p-6 max-w-2xl mx-auto shadow-lg">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              , your support work goes from 0% to 100% handled. Your Garrio team
              of AI and human agents work together seamlessly,
