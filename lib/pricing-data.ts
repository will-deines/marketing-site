...
export const plans: Plan[] = [
  {
    ...
    features: [
      {
        title: "Live analytics dashboard tracks chat volume & resolutions",
        included: true,
      },
      {
        title: "AI feedback loop trains the industry model from your ratings",
        included: true,
      },
      {
        title: "Industry-tuned LLM answers, ready out-of-the-box",
        included: true,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Hard cap—never pay more than your spending cap",
        included: true,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "24 hr email response time; real people on every ticket",
        included: true,
      },
      {
        title: "Brand-trained AI fine-tuned to your store data",
        included: true,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Monthly custom-model refresh keeps answers current",
        included: true,
      },
      {
        title: "Agents spot gaps and fast-feed new data to your AI",
        included: true,
      },
      {
        title: "Priority response & dedicated success manager",
        included: true,
      },
    ],
...
export const comparisonFeatures: ComparisonFeature[] = [
  {
    ...
    plans: {
      free: "250 each month",
      starter: "350 each month",
      essentials: "350 each month",
      professional: "350 each month",
    },
  },
  {
    id: "overage",
